...
export default function DatePickerComponent(props: DatePickerProps) {
  ...
  return (
    ...
    >
      ...
      >
        <ThemeProvider theme={materialTheme}>
          <DatePicker
            ...
            value={eventStart}
            onChange={(date) =>
              setEventTimesOnDateChange(DateTime.fromISO(date.toISOString()))
            }
      ...
      <div className="eventModalTimePlainString" style={{ marginTop: '2px' }}>
        to
      </div>
      ...
      <div
        ...
        onClick={() => {
          setShowTimePicker(true);
          setTimePickerModifying('end');
        }}
      >
        <div className="eventModalTime" style={{ color: endTimeColor }}>
