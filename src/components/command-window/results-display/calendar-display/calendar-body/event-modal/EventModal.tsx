...
export default function EventModal(props: EventModalProps) {
  ...
  const saveButtonOpacity =
    changeMade && eventTitle != '' && eventStart < eventEnd ? '100%' : '40%';
  ...
  return (
    <div style={ModalAreaStyles} onClick={() => setIsOpen(false)}>
      <div style={ModalStyles} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ marginTop: '15px', marginLeft: '7px', display: 'flex' }}>
        ...
        >
          <div
            className="eventModalSaveButton"
            onClick={() => {
              if (changeMade && eventTitle != '' && eventStart < eventEnd) {
                handleSave();
              }
            }}
            style={{
          ...
          >
            <div className="eventModalSaveButtonText">Save</div>
          </div>
          <div
